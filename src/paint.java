    ...
    paint() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                comboBox1.addItemListener(new ItemListener() {
                    ...
                    public void itemStateChanged(ItemEvent e) {
                        ...
                        if(s!=null){
                            nav.setKey(s);
                            AbstractShapeClass a=(AbstractShapeClass) nav.returnshape(s);
                            nav.setPoints(a.points());
                            nav.resetkey();
                        }
                    }
                });
        ...
        nav.addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                ...
                backend.shape[] f = nav.getshapes();
                AbstractShapeClass selectedShape = null;
                for (shape sh : f) {
                    AbstractShapeClass shape = (AbstractShapeClass) sh;
                ...
                for (Point point: points) {
                    if(point.distance(e.getPoint()) <= 10) {
                        ...
                        resize = selectedShape.resize(point, e.getPoint());
                    ...
                    try (Scanner reader = new Scanner(f)) {
                        ...
                        for (Object shape : shapeList) {
                            ...
                            if (s.get(0).charAt(0) == 'c') {
                                ...
                                try {
                                    c.setColor(Color.decode(s.get(2)));
                            ...
                            if (s.get(0).charAt(0) == 's') {
                                ...
                                try {
                                    rec.setColor(Color.decode(s.get(2)));
                                } catch (NullPointerException E) {
                            ...
                            if (s.get(0).charAt(0) == 't') {
                                ...
                                try {
                                    tri.setColor(Color.decode(s.get(2)));
                                } catch (NullPointerException E) {
                                }
                            ...
                            if (s.get(0).charAt(0) == 'l') {
                                ...
                                try {
                                    l.setColor(Color.decode(s.get(2)));
                                } catch (NullPointerException E) {
                                }
                                l.draw(draw_panel.getGraphics());
                                nav.addShape(l);
